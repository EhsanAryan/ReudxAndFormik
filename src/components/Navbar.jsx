...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav class="navbar navbar-expand navbar-dark bg-secondary px-2 fixed-top">
                <a class="navbar-brand" href="https://www.github.com/EhsanAryan" target="_blank" rel="noreferrer">Redux & Formik</a>
